            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="mb-3 row HideShow" style="display:none;">
                        <label for="reminder_date" class="col-sm-2 col-form-label">Reminder Date <span class="radStar ">*</span></label>
                        <div class="col-sm-2">
                            <input type="date" name="reminder_date" class="form-control editInput" id="reminder_date" onchange="setMinEndDate(null)" min="">
                        </div>
                        ...
                        <div class="col-sm-2">
                            <select class="form-control editInput selectOptions" id="payment_terms" name="reminder_before_days">
...
<script>
    ...
    function setMinEndDate(reminder_before_days) {
