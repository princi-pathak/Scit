    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="aupplierModalLabel">New Supplier</h4>
            </div>
                ...
                <form id="supplier_form_data">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Supplier Name <span class="radStar ">*</span></label>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Supplier Code</label>
                                <input type="text" class="form-control editInput textareaInput" placeholder="Enter Supplier Code" id="supplier_code" name="code">
                            </div>
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Contact Name <span class="radStar ">*</span></label>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Fax</label>
                                <input type="text" class="form-control editInput textareaInput" placeholder="Enter Supplier Fax" id="supplier_fax" name="fax">
                            </div>
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Website</label>
                                <div class="row">
                                    <div class="col-sm-3 pe-0 pe-0">
                                        <div class="tag_box">
                                            <span>http://</span>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control textareaInput suppliercheckError" maxlength="300" placeholder="Enter Supplier Address" id="supplier_address" name="address" rows="1"></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Country</label>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Account Ref.</label>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Currency</label>
                            ...
                            <div class="mb-3">
                                <label class="col-form-label mb-2">Credit Limit</label>
                                <div class="row">
