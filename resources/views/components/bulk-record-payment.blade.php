    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content add_Customer">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12">
                        <div class="formDtail">
                            <form id="{{ $bulkRecordPaymentformId }}" class="customerForm pt-0">
                                @csrf
                                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="productDetailTable input_style">
                                        <table class="table" id="bulkRecordPayment_result">
            ...
            <div class="modal-footer customer_Form_Popup">
                <button type="button" class="profileDrop" id="{{ $saveButtonId }}" onclick="saveBulkRecordPaymentModal()">Save</button>
