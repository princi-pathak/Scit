                        ...
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select class="form-control js-example-basic-single" name="company_id[]" {{ (isset($del_status)) ? $disabled: '' }} >
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">Homes</label>
                                <div class="col-lg-9">                                   
                                    <select class="form-control js-example-basic-single" name="" id="getHomesList">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#getHomesList').on('click', function(){
