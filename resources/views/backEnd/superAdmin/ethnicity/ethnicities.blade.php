...
@section('title',' Super Admin Ethnicity')
                ...
                <section class="panel">
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{ url('super-admin/ethnicity/add') }}">
                                        <button id="editable-sample_new" class="btn btn-primary">
                                            Add Ethnicity <i class="fa fa-plus"></i>
                                        </button>
                                    </a>    
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div id="editable-sample_length" class="dataTables_length">
                                        <form method='post' action="{{ url('super-admin/ethnicities') }}" id="records_per_page_form">
                                            <label>
                                ...
                                <div class="col-lg-6">
                                    <form method='get' action="{{ url('super-admin/ethnicities') }}">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        ...
                                        if($ethnicity->isEmpty()){ ?>
                                            <?php
                                                echo '<tr style="text-align:center">
                                                      <td colspan="4">No ethnicity found.</td>
                                                      </tr>';
                                            ?>
                                        <?php 
                                        } 
                                        ...
                                        <tr class="">
                                            ...
                                            <!-- <td class="action-icn" width="25%">
                                                <a href="{{ url('/super-admin/ethnicity/edit/'.$value->id) }}" class="edit"><i data-toggle="tooltip" title="Edit" class="fa fa-edit"></i></a>
                                                <a href="{{ url('super-admin/ethnicity/delete/'.$value->id) }}" class="delete"><i data-toggle="tooltip" title="Delete" class="fa fa-trash-o"></i></a>
                                            </td> -->
                                        </tr>
                                         <?php } } ?>
                                    </tbody>
