                                ...
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="action-icn">
                                                <a href="{{ url('admin/home/access-level/rights/view/'.$value->id) }}" class="edit"><span style = "color: #000;"><i data-toggle="tooltip" title="View Access Rights" class="fa fa-legal fa-lg"></i></span></a> &nbsp&nbsp&nbsp
                                                <a href="{{ url('admin/home/access-level/edit/'.$value->id) }}" class="edit"><i data-toggle="tooltip" title="Edit" class="fa fa-edit fa-lg"></i></a>
                                                <a href="{{ url('admin/home/access-level/delete/'.$value->id) }}" class="delete"><i data-toggle="tooltip" title="Delete" class="fa fa-trash-o fa-lg"></i></a>
                                            </td>
