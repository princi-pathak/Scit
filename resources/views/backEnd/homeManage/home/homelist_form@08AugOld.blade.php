                    ...
                    <div class="panel-body">
                        <div class="position-center">
                           ...
                           <div class="form-group has-feedback">
							...
							<?php
								$pdf_file = 'No file selected';
								if(isset($homelist->security_policy))
								{
									if(!empty($homelist->security_policy)){ 
										$pdf_file = SecurityPolicyFilePath.'/'.$homelist->security_policy;
									?>
									<div class="form-group">
										<label class="col-lg-2 control-label">Security Policy</label>
										<div class="col-md-10">
											<a href="{{ $pdf_file }}" target="_blank"> {{ $homelist->security_policy }} </a>
										</div>
									</div>
									 <?php }
								}
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">{{ isset($homelist->security_policy) ? 'New' : '' }} Security Policy</label>
								<div class="col-md-10">
									<input type="file" id="security_policy" name="security_policy" val="">
								</div>
							</div>
