...
<?php
    $page_url = url('admin/customer_type');
?>
                        ...
                        <div class="adv-table editable-table ">
                         <div class="row"> 
                          <div class="col-lg-6">  
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{url('admin/customer_type_add')}}">
                                        <button id="editable-sample_new" class="btn btn-primary">
                                            Add Customer Type <i class="fa fa-plus"></i>
                                        </button>
                                    </a>    
                                </div>
                                        ...
                                        if(count($customer_type) == 0){ ?>
                                            <?php
                                                echo '<tr style="text-align:center">
                                                      <td colspan="4">No Customer Type found.</td>
                                                      </tr>';
                                            ?>
                                        <?php 
                                        } 
...
<script>
    function status_change(id,status){
        ...
        var token='<?php echo csrf_token();?>'
            $.ajax({  
                type:"POST",
                url:"{{url('admin/customer_type_status_change')}}",
    ...
    function delete_job(id){
       if(confirm("Do you want to delete it ?")){
        ...
        var token='<?php echo csrf_token();?>'
            $.ajax({  
                type:"POST",
                url:"{{url('admin/customer_type_delete')}}",
