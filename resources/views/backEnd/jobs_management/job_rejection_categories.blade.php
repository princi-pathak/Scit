                        ...
                        <div class="adv-table editable-table ">
                         <div class="row"> 
                          <div class="col-lg-6">  
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{url('admin/job_rejection_category_add')}}">
                                        <button id="editable-sample_new" class="btn btn-primary">
                                            Add Appoinitment Rejection Category <i class="fa fa-plus"></i>
                                        </button>
                                    </a>    
                                </div>
                           ...
                           <div class="col-lg-6">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        <?php
                                        if(count($rejectionCat) == 0){ ?>
                                            <?php
                                                echo '<tr style="text-align:center">
                                                      <td colspan="5">No Job Type found.</td>
                                                      </tr>';
                                            ?>
                                        <?php 
                                        } 
                                        ...
                                        {
                                            foreach($rejectionCat as $key => $val) 
                                            {  ?>
                                        ...
                                        <tr >
                                            ...
                                            <td class="action-icn">
                                                <a href="{{ url('admin/job_rejection_category_add?key=')}}{{base64_encode($val->id)}}" class="edit"><span style= "font-size: 13px; color: #000;"><span style= "color: #000"><i data-toggle="tooltip" title="Edit" class="fa fa-edit fa-lg"></i></span></a> &nbsp &nbsp &nbsp 
