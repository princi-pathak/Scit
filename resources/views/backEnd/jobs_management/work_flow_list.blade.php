...
<?php
    $page_url = url('admin/work_flow_list');
?>
                        ...
                        <div class="adv-table editable-table ">
                         <div class="row"> 
                          <div class="col-lg-6">  
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="{{url('admin/work_flow_add')}}">
                                        <button id="editable-sample_new" class="btn btn-primary">
                                            Add Workflow <i class="fa fa-plus"></i>
                                        </button>
                                    </a>    
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            <td class="user_name">{{ ucfirst($val->flow_name) }}</td>
                                            <td>
                                                @if($val->status == 1)
...
<script>
    function status_change(id,status){
        ...
        var token='<?php echo csrf_token();?>'
            $.ajax({  
                type:"POST",
                url:"{{url('admin/wrok_flow_status_change')}}",
    ...
    function delete_job(id){
       if(confirm("Do you want to delete it ?")){
        ...
        var token='<?php echo csrf_token();?>'
            $.ajax({  
                type:"POST",
                url:"{{url('admin/wrok_flow_delete')}}",
