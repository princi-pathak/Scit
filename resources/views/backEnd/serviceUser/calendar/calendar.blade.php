...
a.btn-bck:hover, a.btn-bck:focus {
color: #fff;
}
.bars li {
font-size: 14px;
    ...
    <section class="wrapper-api" >
        <!-- page start-->
            ...
            <header class="panel-heading head-cal1">
                {{ $page_title }}
                <a class="pull-right btn btn-bck" href="{{ url('admin/service-users') }}">Back </a>
            </header>
...
@include('backEnd.serviceUser.calendar.elements.calender_event_detail')
...
<script>
    ...
    $('#calendar').fullCalendar({
        ...
        eventClick: function(event) { 
            ...
            $.ajax({
                type: 'get',
                url : "{{ url('admin/service-user/calendar/event/view') }}",
