                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" class="edit"><span style="color: #000;"><i data-toggle="modal" title="Edit" data-id="{{ $value->id }}" data-title="{{ $value->title }}" data-status="{{ $value->status }}" data-target="#secondModal" class="fa fa-edit fa-lg open-modal"></i></a>
                                                <a href="{{ url('admin/sales-finance/leads/lead_task_type/delete').'/'.$value->id }}" class="delete"><i data-toggle="tooltip" title="Delete" class="fa fa-trash-o fa-lg"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="lead_task_type_form">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-lg-3 col-sm-3 ">Task Type</label>
                        <input type="text" class="form-control" name="title" placeholder="Task Type" id="title">
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="saveChanges" class="btn btn-primary">Add</button>
            </div>
        </div>
    </div>
</div>
