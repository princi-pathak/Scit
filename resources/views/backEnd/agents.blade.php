                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="action-icn">
                                                ...
                                                @else
                                                    <a href="{{ url('admin/agents/edit/'.$value->id.'?del_status='.$del_status) }}" class="edit"><span style = "color: #000;"><i data-toggle="tooltip" title="View" class="fa fa-eye fa-lg"></i></span></a>
                                                @endif
                                            </td>
