                ...
                <div class="col-lg-12">
                    <div class="staffHeaderp">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <button class="bgBtn pgreenBtn" type="button"><i
                ...
                <div class="bBorderCard mt-4 p-4">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <p class="para text-sm">Jan 20 - Jan 26, 2025</p>
                            <div><span class="careBadg darkBlackBadg">draft</span></div>

                        </div>
                        <div>
                            <p class="text-sm para">Pay Date </p>
                            <h5 class="h5Head mb-0">Jan 31, 2025</h5>
                        </div>
                    </div>
                ...
                <div class="col-lg-3">
                    <div class="rota_dash-card gradp-purple-50 p-4 lightBorderp rouded8">
                        <div class="rota_dash-left w100">
                            ...
                            <p class="fs13 purpleTextp"> Need approval </p>
                        </div>
                    </div>
            ...
            <div class="row mt20">
                <div class="col-lg-12">
                    <div class="emergencyMain p24">
                        <h6 class="h6Head">Recent Payroll Activity</h6>
                        <div class="muteBg rounded8 p-4 mt-4">
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0  muteText">Net Pay</p>
                                </div>
                            </div>
                        </div>
                        <div class="muteBg rounded8 p-4 mt-4">
