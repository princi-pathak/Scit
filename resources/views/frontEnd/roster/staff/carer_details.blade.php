                    ...
                    <div class="bgWhite lightBorderp rounded8 cursorPointer">
                        <div class="cardHeaderp p24">
                            <div class="flexBw">
                                ...
                                <div>
                                    <span class="careBadg redbadges"><i class="bx bx-alert-triangle"></i> Next: overdue </span>
                                </div>
                            </div>
                        </div>
                        <div class="p-4">
                            <div class="lightBorderp rounded8 p-4 hoverBg" data-toggle="modal" data-target="#superDetailModal" type="button">
                                <div class="flexBw">
                                    <div>
                                        <h6 class="h6Head mb-3"> <i class="bx bx-calendar-week fs18 textGray500 me-2"></i> 10 Feb 2026
                                            <span class="borderBadg ms-2">formal one to one</span>
                                        </h6>
                                        <p class="fs13 textGray500 mb-0">Supervised by Unknown</p>
                                    </div>
                                    <div>
                                        ...
                                        <div class="col-lg-12 m-t-10">
                                            ...
                                            <div class="lightBorderp p-3 rounded8 muteBg">
                                                <div class="dFlexGap">
                                                    ...
                                                    <div>
                                                        <p class="fs13 font700 mb-2">Braden QD, Communication, and Condition Specific Assessment</p>
                                                    ...
                                                    <div class="dFlexGap">
                                                        ...
                                                        <div>
                                                            <p class="fs13 mb-2 font700">
                                                                Braden QD, Communication, and Condition Specific Assessment
                                                            </p>
                                                            <div class="dFlexGap">
                                                                <div class="userMum">
                                                                    <span class="title bgWhite50 mt-0 hoverBg">Healthcare Clinical Assessment
                                                                    </span>
                                                                </div>
