                        ...
                        <div class="tab-content carertabcontent">
                            <div class="content active" id="overviewTab">
                                <div class="careInsightsWrap">
                                    ...
                                    <div class="blankCarer">
                                        <div class=" leave-card" style="height: 300px;">
                                            <div class="leavebanktabCont blankdesign">
                                                <i class="bx bx-user"></i>
                                                <h4 class="font600">Select a carer</h4>
                                                <p class="textGray500">Choose a carer from the list to manage their availability</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="calendarTrack">
                                                ...
                                                <div class="month active">
                                                    <div class="dates">
                                                        ...
                                                        <div class="cell workingDateCle">4 <div class="pill working">Working</div>
                                                            <div class="pill">09:00 - 17:00</div>
                                                        </div>
                                                        <div class="cell unavailableDateCle">5<div class="pill unavailable">Unavailable</div>
                                                        </div>
                                                        ...
                                                        <div class="cell active">19<div class="pill dayoff">Day Off</div>
                                                        </div>
