        ...
        <div class="container-fluid">
            ...
            <div class="topHeaderCont">
                ...
                <div class="header-actions addnewicons">
                    <button class="btn allBtnUseColor" data-toggle="modal" data-target="#AddFirstEntry"><i
                            class='bxdm  bx-plus'></i> Add Entry</button>
                </div>
            </div>
                                    ...
                                    <div class="entryCardbx">
                                        <div class="planCard">
                                            ...
                                            <div class="AddFirstDetailsEntry">
                                                ...
                                                <div class="planFooter">
                                                    <span class="redalrttext"><i class='bx  bx-alert-circle'></i> Follow-up:
                                        ...
                                        <div class="planCard">
                                            <div class="planTop">
                                                <div class="planTitle">
                                                    <span class="heartIcon greenLightClr"><i
                        ...
                        <div class="">
                            <div class="leave-card">
                                <div class="leavebanktabCont blankdesign">
                                    ...
                                    <button class="btn allbuttonDarkClr" data-toggle="modal" data-target="#AddFirstEntry"><i
                                            class="bxdm  bx-plus"></i> Add First Entry</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="carer-form">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-md-12  m-t-10">
                                        <label>Notes</label>
                                        <textarea name="Notes" class="form-control" rows="5" cols="20"
                                ...
                                <div class="overtime followUpAction ">
                                    <label>
                                        <input type="checkbox" name="available_for_overtime" value=""> Follow-up action
                                        required
                                    </label>
                                    <div class="extraHours" style="display: none;">
                                        <label>Follow-up Details</label>
                                        <textarea name="" class="form-control" rows="2" cols="20"
                                            placeholder="What needs to be done?" maxlength="1000"></textarea>
                                    </div>
                                </div>
