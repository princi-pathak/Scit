                ...
                <div class="col-lg-12">
                    <div class="bBorderCard mt-4 urReqSec">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="{{ url('roster/incident-report-details') }}" class="borderBtn"><i
                                        class='bx  bx-eye f18 me-3 '></i> View</a>
                            </div>
                        </div>
                    ...
                    <div class="bBorderCard mt-4 urReqSec">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <button class="borderBtn"><i class='bx  bx-eye f18 me-3 '></i> View</button>
                            </div>
                        </div>
