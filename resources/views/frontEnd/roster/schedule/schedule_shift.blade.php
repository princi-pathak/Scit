 ...
 <main class="page-content">
                                         ...
                                         <div class="carePlanWrapper">
                                             ...
                                             <div class="planCard redBgAndBorder">
                                                 <div class="planTop">
                                                     ...
                                                     <div class="header-actions">
                                                         <div class="issuesDropdown dropModalShift">
                                                             ...
                                                             <ul class="issuesDetectedDrop">
                                                                 ...
                                                                 <li><a href="#!"><i class='bx  bx-user-minus'></i>
                                                                         Unassign Carer</a></li>
                                                                 <li><a><i class='bx  bx-paper-plane'></i> <button type="button" id="openModals" style="background:#fff">Send Coverage Request</button></a></li>
                                                             </ul>
                                                     ...
                                                     <!-- <div class="modal fade leaveCommunStyle" id="sendCoverage" tabindex="-1" role="dialog"
                                                        aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog pModalScroll modal-lg">
                                                            <div class="modal-content sendShiftModal">
                                                                <div class="modal-header bluePurpleDarkGrad">
                                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: #fff;">&times;</button>
                                                                    <div class="dFlexGap gap-4">
                                                                        <div class="shiftHeadIcon">
                                                                            <i class="bx bx-send fs30 whiteText"></i>
                                                                        </div>
                                                                        <div>
                                                                            <h4 class="modal-title whiteText"> Send Shift Request
                                                                            </h4>
                                                                            <p class="fs13 mb-0 whiteText" style="opacity: 0.8;">Send Shift Request
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="modal-body heightScrollModal">
                                                                    <div class="blueShadowLight p24 rounded8 bgWhite">
                                                                        ...
                                                                        <div class="mt20">
                                                                            <div class="d-flex">
                                                                                <div class="flex1">
                                                                                    <div class="dFlexGap">
                                                                                        <div>
                                                                                            <i class="bx bx-user f18 blueText"></i>
                                                                                        </div>
                                                                                        <div>
                                                                                            <p class="fs12 textGray500">Client</p>
                                                                                            <h6 class="h6Head mb-0 blackText">Unknown</h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="flex1">
                                                                                    <div class="dFlexGap">
                                                                                        <div>
                                                                                            <i class="bx bx-calendar-week f18 greenText"></i>
                                                                                        </div>
                                                                                        <div>
                                                                                            <p class="fs12 textGray500">Date</p>
                                                                                            <h6 class="h6Head mb-0 blackText">Mon, Feb 16, 2026
                                                                            ...
                                                                            <div class="d-flex mt-4">
                                                                                <div class="flex1">
                                                                                    <div class="dFlexGap">
                                                                                        <div>
                                                                                            <i class="bx bx-clock f18 purpleTextp"></i>
                                                                                        </div>
                                                                                        <div>
                                                                                            <p class="fs12 textGray500">Time </p>
                                                                                            <h6 class="h6Head mb-0 blackText">09:00 - 17:00</h6>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="flex1">
                                                                                    <div class="dFlexGap">
                                                                                        <div>
                                                                                            <i class="bx bx-clock  f18 orangeText"></i>
                                                                                        </div>
                                                                                        <div>
                                                                                            <p class="fs12 textGray500">Duration</p>
                                                                                            <h6 class="h6Head mb-0 blackText">Mon, Feb 16, 2026
                                                                    ...
                                                                    <div class="mt20">
                                                                        <p class="fs13 font600">Priority Level </p>
                                                                    ...
                                                                    <div class="mt20">
                                                                        <p class="fs13 font600">Request Expires In </p>
                                                                        <div class="dFlexGap gap-2">
                                                                            <div class="borderBtn hourBtn">12h</div>
                                                                            <div class="borderBtn hourBtn">23h</div>
                                                                            <div class="borderBtn hourBtn">45h</div>
                                                                            <div class="borderBtn hourBtn">45h</div>
                                                                        </div>
                                                                    ...
                                                                    <div class="mt20">
                                                                        ...
                                                                        <div class="m-t-10">
                                                                            <textarea class="form-control" rows="3" placeholder="Add any additional information for the carers..." name=""></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt20">
                                                                        <div class="flexBw">
                                                                            <label for="">Select Carers (0 selected)</label>
                                                                            <div class="dFlexGap">
                                                                                <button class="borderBtn selectAll">Select All</button>
                                                                                <button class="borderBtn clearAll">Clear All</button>
                                                                            </div>
                                                                        </div>
                                                                        <div class="mt-4 lightBorderp p-3 rounded8 scrollDailyCheck sendShiftCheck">
                                                                            <div class="">
                                                                                <div class="row">
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="rounded8 lightBorderp p-3 hoverBg">
                                                                                            <label for="acc1">

                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc1" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                                                        <h5 class="h5Head mb-2">
                                                                                                            Mick Carter</h5>
                                                                                                        <p class="fs12 mb-0 textGray500"> Full time</p>
                                                                                                    </div>
                                                                                                </div>
                                                                                    ...
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="rounded8 lightBorderp p-3 hoverBg">
                                                                                            <label for="acc2">
                                                                                                ...
                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc2" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                                    ...
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="p-3 rounded8 lightBorderp hoverBg">
                                                                                            <label for="acc3">

                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc3" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                                    ...
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="rounded8 lightBorderp p-3 hoverBg">
                                                                                            <label for="acc4">
                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc4" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                                    ...
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="rounded8 lightBorderp p-3 hoverBg">
                                                                                            <label for="acc5">
                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc5" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                                    ...
                                                                                    <div class="col-lg-6 m-t-10">
                                                                                        <div class="rounded8 lightBorderp p-3 hoverBg">
                                                                                            <label for="acc6">
                                                                                                <div class="dFlexGap">
                                                                                                    <input type="checkbox" id="acc6" value="15" class="checkBoxHW alertCheck">
                                                                                                    <div class="bgIconStaffT darkBlueGrad rounded50 whiteText">
                                                                                                        M
                                                                                                    </div>
                                                                                                    <div>
                                                                ...
                                                                <div class="modal-footer d-flex justify-content-start">
                                                                    <div class="dFlexGap w100">
                                                                        <button class="borderBtn close flex1" data-dismiss="modal" aria-hidden="true">Cancel</button>
                                                                        <button class="bgBtn bluePurpleDarkGrad flex1">Send to 0 Carers</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                     ...
                                                     <!-- unassigned detail modal -->
                                                     <div class="modal " id="firstModal" tabindex="-1">
                                                         <div class="modal-dialog modal-lg">
                                                             <div class="modal-content sendShiftModal  aiConflictMain">
                                                                 <div id="firstModalOverlay"></div>
                                                                 <div class="modal-header aIInsightsheader" style="padding: 24px">
                                                                     <button type="button" class="close blackText" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                                     <div class="dFlexGap gap-4">
                                                                         <div class="shiftHeadIcon bluePurpleDarkGrad rounded50">
                                                                             <i class="bx bx-brain fs30 whiteText"></i>
                                                                         </div>
                                                                         <div class="blackText">
                                                                             <h4 class="modal-title"> AI Conflict Resolver
                                                                             </h4>
                                                                             <p class="fs13 mb-0">Smart solutions for scheduling conflicts</p>
                                                                         </div>
                                                                     </div>
                                                                 </div>
                                                                 <div class="modal-body" style="padding: 0px">
                                                                     <div class="bg-orange-50 py-3">
                                                                         <div class="dFlexGap dFlexGap align-items-start">
                                                                             <div>
                                                                                 <i class="bx bx-alert-triangle orangeText f20"></i>
                                                                             </div>
                                                                             <div>
                                                                                 <h6 class="h6Head darkOrangeTextp">
                                                                                     Conflict Details </h6>
                                                                                 <p class="mb-0 fs13 darkOrangeTextp">
                                                                                     Unfilled shift for Elizabeth Barrett on Feb 16 at 09:00 </p>

                                                                             </div>
                                                                         </div>
                                                                     </div>
                                                                     <div class="p24">
                                                                         <h6 class="h6Head"><i class="bx bx-sparkles-alt purpleTextp fs23"></i> Recommended Solutions</h6>

                                                                         <div class="leavebanktabCont">
                                                                             <i class="bx bx-alert-triangle"></i>
                                                                             <h4 class="fs16">No alternative solutions available</h4>
                                                                             <p class="fs13 textGray500">You may need to manually adjust the schedule</p>
                                                                         </div>
                                                                     </div>
                                                                 </div>
                                                     ...
                                                     <!-- Second Modal (Front) -->
                                                     <div class="modal  leaveCommunStyle" id="secondModal" tabindex="-1">
                                                         <div class="modal-dialog pModalScroll modal-lg">
                                                             <div class="modal-content sendShiftModal">
                                                                 <div class="modal-header bluePurpleDarkGrad" style="padding: 24px">
                                                                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: #fff;">&times;</button>
                                                                     <div class="dFlexGap gap-4">
                                                                         <div class="shiftHeadIcon">
                                                                             <i class="bx bx-send fs30 whiteText"></i>
                                                                 ...
                                                                 <div class="modal-footer d-flex justify-content-start">
                                                                     <div class="dFlexGap w100">
                                                                         <button class="borderBtn flex1" data-dismiss="modal" aria-hidden="true">Cancel</button>
                                                                         <button class="bgBtn bluePurpleDarkGrad flex1">Send to 0 Carers</button>
                                                                     </div>
                                                                 </div>
                                                             </div>
     ...
     <script>
         $(document).ready(function() {
             ...
             var overlay = $('#firstModalOverlay');

             $('#openModals').on('click', function() {

                 // Show first modal without animation
                 firstModal.modal({
                     backdrop: true,
                     keyboard: true,
                     show: true
                 ...
                 // Small timeout so Bootstrap body class apply ho jaye
                 setTimeout(function() {
                 ...
                 }, 0); // 300ms important for first time
         ...
         priorityBtns.forEach(btn => {
             btn.addEventListener('click', function() {
                 ...
                 priorityBtns.forEach(b => {
                     b.classList.remove('shiftBlueBadg', 'yellowBadges', 'redBadges', 'highBadges', "muteBadges");
                 });

                 const type = this.dataset.type;

                 if (type === 'low') {
                     this.classList.add('muteBadges');
                 }
                 if (type === 'normal') {
                     this.classList.add('shiftBlueBadg');
                 }
                 if (type === 'high') {
                     this.classList.add('highBadges');
                 }
                 if (type === 'urgent') {
                     this.classList.add('redBadges');
                 }
             });
         });
     </script>
     <script>
         const hourBtns = document.querySelectorAll('.hourBtn');

         hourBtns.forEach(btn => {
             btn.addEventListener('click', function() {

                 hourBtns.forEach(b => b.classList.remove('blackActive'));

                 this.classList.add('blackActive');
             });
         });
     </script>
