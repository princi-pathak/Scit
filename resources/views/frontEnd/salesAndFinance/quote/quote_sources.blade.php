    ...
    <div class="modal-dialog">
        <div class="modal-content add_Customer">
            <div class="modal-header terques-bg">
                ...
                <h5 class="modal-title pupTitle">Quote Sources - Add</h5>
            </div>
            <div class="modal-body">
                <form role="form" id="quote_source_form">
                    @csrf
...
<script>
    $(document).ready(function() {
        $('.open-modal').on('click', function() {
            ...
            if (itemId) {
                ...
                $('#title').val(itemTitle);
                $('#status').val(itemStatus);
                $('.modal-title').text('Quote Sources - Edit');
                ...
                $('.modal-title').text('Quote Sources - Add');
    ...
    function deleteRow(id) {
        ...
        $.ajax({
            url: '{{ route("quote.ajax.deleteQuoteSource") }}',
            method: 'POST',
            data: {
                id: id
            },
