...
<style>
    ...
    <section class="main_section_page px-3">
                                        ...
                                        <div class="d-inline-flex align-items-center ">
                                            <div class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu fade-up m-0">
                                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#customerPop" class="dropdown-item open-modal" data-id="{{ $val->id }}" data-title="{{ $val->title }}" data-status="{{ $val->status }}">Edit Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content add_Customer">
                                ...
                                <div class="modal-footer customer_Form_Popup">
                                    ...
                                    <button type="button" class="profileDrop" onclick="save_attachment_typeClose()">Save &
                                        Close</button>
        ...
        <script>
            ...
            function save_attachment_typeClose(){
                var name=$("#name").val();
                if(name == ''){
                    $("#name").addClass('addError');
                    return false;
                } else {
                    get_save_attachment_type();
