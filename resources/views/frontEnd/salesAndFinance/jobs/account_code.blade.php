                                        ...
                                        <div class="d-inline-flex align-items-center ">
                                            <div class="nav-item dropdown">
                                                ...
                                                <div class="dropdown-menu fade-up m-0">
                                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#customerPop" class="dropdown-item modal_dataFetch" data-id="{{ $val->id }}" data-title="{{ $val->name }}" data-departmental_code="{{$val->departmental_code}}" data-status="{{ $val->status }}">Edit Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12">
                                            <div class="formDtail">
                                                <form id="form_data" class="customerForm pt-2">
                                                    ...
                                                    <div class="mb-2 row">
                                                        <label for="inputName" class="col-sm-3 col-form-label">Departmental Code</label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="form-control editInput"
                                                                id="departmental_code" name="departmental_code" value="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
