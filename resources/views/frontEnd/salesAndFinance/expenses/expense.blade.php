                    ...
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <div class="jobsection">
                                ...
                                <a href="{{url('expenses?key=paid&value=1')}}" class="btn btn-warning bgcolor" id="bgcolor4">Paid ({{$paidCount}})</a>
                            ...
                            <div class="delete_table_row">
                                ...
                                <table class="table border-top border-bottom tablechange" id="exampleOne">
                                                    ...
                                                    <div class="pageTitleBtn p-0">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right fade-up m-0">
                                                                <a href="#" class="dropdown-item col-form-label fetch_data" data-toggle="modal" data-target="#customerPop" data-id="{{$val->id}}" data-title="{{$val->title}}" data-amount="{{$val->amount}}" data-vat="{{$val->vat}}" data-vat_amount="{{$val->vat_amount}}" data-gross_amount="{{$val->gross_amount}}" data-expense_date="{{$val->expense_date}}" data-user_id="{{$val->user_id}}" data-reference="{{$val->reference}}" data-customer_id="{{$val->customer_id}}" data-job="{{$val->job}}" data-project_id="{{$val->project_id}}" data-job_appointment_id="{{$val->job_appointment_id}}" data-authorised="{{$val->authorised}}" data-billable="{{$val->billable}}" data-paid="{{$val->paid}}" data-notes="{{$val->notes}}" data-attachments="{{$val->attachments}}">Edit</a>
                                    ...
                                    <tr class="calcualtionShowHide">
                                        <td colspan="18">Page Sub Total:</td>
                                    </tr>
                                    <tr class="calcualtionShowHide">
                                        <td colspan="9"></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="customerModalLabel">Expenses</h4>
            </div>
                        ...
                        <form id="form_data" class="customerForm">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Expense Name <span class="radStar">*</span></label>
                                        <input type="text" class="form-control editInput"
                                            id="title" name="title" value="" placeholder="Expense Name">
                                    </div>
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Net Amount <span class="radStar">*</span></label>
                                        <input type="text" class="form-control editInput"
                                            id="amount" name="amount" value="" placeholder="Net Amount">
                                    </div>
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Vat <span class="radStar">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Vat Amount</label>
                                        <input type="text" class="form-control editInput"
                                            id="vat_amount" name="vat_amount" value="" onkeyup="calculate_vat()">
                                    </div>
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Gross Amount <span class="radStar">*</span></label>
                                        <input type="text" class="form-control editInput"
                                            id="gross_amount" name="gross_amount" value="" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Expense Date <span class="radStar">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Reference</label>
                                        <input type="text" class="form-control editInput" id="reference" name="reference" value="">
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="mb-3">
                                        <label for="inputProject"
                                            class="mb-2 col-form-label">Customer</label>
                                        <select class="form-control editInput selectOptions"
                                    ...
                                    <div class="mb-3">
                                        <label for="inputProject"
                                            class="mb-2 col-form-label">Project</label>
                                        <select class="form-control editInput selectOptions"
                                    ...
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Job</label>
                                        <div class="textbox completeIt">
                                            ...
                                            <div class="icon"></div>
                                            <div class="autoCompleteJob" id="jobList"></div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProject"
                                            class="mb-2 col-form-label">Job Appointment</label>
                                        <select class="form-control editInput selectOptions"
                                    ...
                                    <div class="mb-3">
                                        <label class="mb-2 col-form-label">Authorised</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="col-form-label mb-2">Paid</label>
                                        <div class="form-check form-check-inline">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-xl-12">
                                    <div class="mb-3">
                                        <label class="col-form-label mb-2">Notes</label>
                                        <textarea class="form-control textareaInput" name="notes" id="notes" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="col-form-label mb-2">Attachments</label>
                                        <input type="file" class="editInput" id="attachments" name="attachments" value="">
