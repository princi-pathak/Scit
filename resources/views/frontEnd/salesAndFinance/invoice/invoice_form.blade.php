...
var invoice_id="<?php if(isset($invoice) && $invoice !=''){echo $invoice->id;} else{echo 'null';}?>";
var invoice_ref="<?php if(isset($invoice) && $invoice !=''){echo $invoice->invoice_ref;} else{echo 'null';}?>";
