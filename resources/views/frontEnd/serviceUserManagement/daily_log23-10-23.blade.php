                            ...
                            <div class="timeline-desk">
                                <div class="panel">
                                    <div class="panel-body">
                                        ...
                                        <div class="logimg"><a><img class="" src="{{url('upload/events/'.$key['image_name'])}}" style="width:100px" /></a></div>
                                        <?php } ?>
                    ...
                    for(var i=0; i<resp.log_book_records.length; i++)
                    {
                        if (i%2 !=0)
                        {
                            ...
                            if(resp.log_book_records[i]['image_name']!=''){
                                $(pannel_body).append($(`
                                <div class="logimg"><a><img class="" src="{{url('upload/events/')}}/${resp.log_book_records[i]['image_name']}" style="width:100px" /></a></div>
                                            `));
                            }
                            // image
                            $(pannel_body).append($(`
