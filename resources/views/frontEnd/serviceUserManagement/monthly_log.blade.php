                                ...
                                <div class="timeline-desk">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            @else
                                            <h1 class="title_time_log"><span class="log_title">{{ $key['title']}}</span>
                                            </h1>
                                            @endif
                                            <?php if ($key['image_name'] != '') { ?>
                                            <div class="logimg"><a
                                                    href="{{url('upload/events/'.$key['image_name'])}}"><img class=""
                                                        src="{{url('upload/events/'.$key['image_name'])}}" /></a></div>
                                            <?php } ?>
                                            ...
                                            <p class="daily_log_time">
                                                ...
                                                @else
                                                | <span
                                                    style="red">{{ date("d-m-Y H:i", strtotime($key['created_at'])) }}</span>
                                                @endif
                                                @endif
                                            </p>
                                            <div class="comment-number-bnt-info">
                                                <a data-toggle="modal"
                                                    ...
                                                    href="#commentsModal" id="commentModal1"
                                                    class="btn daily_log_comments_btn"
                                    ...
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="comment-number-bnt-info">
                                                <a data-toggle="modal"
                                                    onclick="daily_log_comment({{$key['id']}}, {{$service_user_id}})"
                                                    data-id="{{$key['id']}}" href="#commentsModal" id="commentModal2"
                                                    class="btn daily_log_comments_btn"
                                                    style="background-color:#1f88b5;color:white;float:right;font-size: 10px;padding: 4px;margin-bottom:15px;">
                                                    Comments
                                                    <span id="_{{$key['id']}}"
