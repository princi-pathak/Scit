    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Set shopping budget for Childs</h4>
            </div>
                ...
                <div class="row">
                    <form id="deposit_shopping_budget" method="post" action="{{ url('shopping_budget/add') }}">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">          
                            ...
                            <label class="col-md-12 m-t-10"> Note: This money will be automatically added/subtracted to all selected Child's My money.</label>
