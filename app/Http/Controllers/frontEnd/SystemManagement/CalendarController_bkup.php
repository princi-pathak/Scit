...
class CalendarController extends SystemManagementController
{
	public function index(Request $request)
	{
		...
		return view('frontEnd.systemManagement.calendar', compact('service_users', 'appointment_plans', 'system_calendar', 'staff', 'log', 'labels', 'guide_tag', 'staff_members', 'user_type', 'members', 'ml_record', 'selected_user_id'));
	}
