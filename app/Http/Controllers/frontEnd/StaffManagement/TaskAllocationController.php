                                        ...
                                        <span class="input-group-addon cus-inpt-grp-addon '.$record_set_btn_class.' settings">
                                            ...
                                            <div class="pop-notifbox">
                                                <ul class="pop-notification" type="none">
                                                    <li> <a href="#" class="edit-task-detail" staff_m_task_id="'.$value->id.'"> <span> <i class="fa fa-pencil"></i> </span> Edit </a> </li>
                                                    <li> <a href="#" class="remove-task-record" staff_m_task_id="'.$value->id.'"> <span class="color-red"> <i class="fa fa-exclamation-circle"></i> </span> Remove </a> </li>
                                                    ...
                                                    <li> <a href="#" staff_m_task_id="'.$value->id.'" class="task_status_change"> <span class="color-yellow"> <i class="fa fa-bolt"></i> </span> Active/Inactive </a></li>
