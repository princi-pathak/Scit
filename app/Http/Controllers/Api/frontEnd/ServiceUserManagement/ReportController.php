...
class ReportController extends ServiceUserManagementController
{
    public function index(Request $request){
        ...
        return view('frontEnd.serviceUserManagement.report',compact('service_user_id','totaleventsadded','totalappointments','totalpolicecall','missingserviceuser','policecallpermonths','appointmentpermonths'));
    }
