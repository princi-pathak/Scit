...
class CalendarController extends Controller
{
	public function index($service_user_id = null) {
		...
		if(!empty($service_user)){
			...
			return view('frontEnd.serviceUserManagement.calendar', compact('event_type','service_user_id','page_title','health_records','daily_records','su_incentives','event_records','appointment_plans','service_users','calender_notes','living_skills','education_records','labels','su_log_books','guide_tag','staff_members'));
		} else {
